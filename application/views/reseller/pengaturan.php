...
<body class="page-profile">
            ...
            <div class="widget-header">
              <div class="widget-header-content">
                <a class="avatar avatar-lg" href="javascript:void(0)">
                  <img src="<?php echo base_url('assets/admin/images/pengaturan.png'); ?>" alt="JombangNetwork">
                </a>
                <div class="profile-user">Jombang Network</div>
                <div class="profile-job">Web Development</div>
                <p>Terima kasih telah menggunakan Jombang Network-Panel, Diharapkan partisipasinya baik berupa
                saran ataupun kritikan untuk pengembangan Jombang Network-Panel. </p>
                <div class="profile-social">
                  <a class="icon bd-twitter" href="https://twitter.com/Jakdev28"></a>
                  <a class="icon bd-facebook" href="https://www.facebook.com/Jakdev28"></a>
                  <a class="icon bd-github" href="https://github.com/Jakdev121"></a>
                </div>
  ...
  <footer class="site-footer">
    ...
    <div class="site-footer-right">
      Powered By <a href="https://www.facebook.com/Jakdev28">MasJak</a>
    </div>
  </footer>
